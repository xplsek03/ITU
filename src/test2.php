<?php 
	...
	if(!$nonvalid) {	
		if(empty($_POST["final_age"]) || empty($_POST["final_spec"]) || empty($_POST["final_tv"]) || empty($_POST["final_fb"]) || empty($_POST["final_game"]) || empty($_POST["final_book"]) || empty($_POST["final_music"]) || empty($_POST["final_pc"]) || empty($_POST["final_time"])) {
			$nonvalid = True;
		}
		...
		if(!$nonvalid && ($_SESSION["tv"] < 1 || $_SESSION["tv"] > 5))
			$nonvalid = True;
		if(!$nonvalid && ($_SESSION["fb"] < 1 || $_SESSION["fb"] > 5))
			$nonvalid = True;
		if(!$nonvalid && ($_SESSION["game"] < 1 || $_SESSION["game"] > 5))
			$nonvalid = True;
		if(!$nonvalid && ($_SESSION["book"] < 1 || $_SESSION["book"] > 5))
			$nonvalid = True;
		if(!$nonvalid && ($_SESSION["pc"] < 1 || $_SESSION["pc"] > 5))
			$nonvalid = True;
		if(!$nonvalid && ($_SESSION["music"] < 1 || $_SESSION["music"] > 5))
			$nonvalid = True;
