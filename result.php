<?php 
	...
	if(!isset($_SESSION["score7"]) || empty($_SESSION["score7"]))
   	...
   	if(!$invalid) {
		...
		// napoj se na db a ulzo do ni vysledky
    	...
    	$statement = $link->prepare("INSERT INTO Results(id, age, spec,child,married,tv,fb,game,book,pc,music,score) VALUES(?,?,?)");
	
    	$statement->execute(array(null,$_SESSION["age"],$_SESSION["spec"],$_SESSION["child"],$_SESSION["married"],$_SESSION["tv"],$_SESSION["fb"],$_SESSION["game"],$_SESSION["book"],$_SESSION["pc"],$_SESSION["music"],$score));
...
<?php include("head.php"); ?>
	...
	<br>
	<span class="logo-inner">Otestuj se.</span>
	</header>
